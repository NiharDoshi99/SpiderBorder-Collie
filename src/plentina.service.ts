...
export class PlentinaService {
  ...
  healthCheck(): string {
    ...
    return JSON.stringify("Nihar Doshi");
  }
  ...
  doesCircleAndRectCollide(
    ...
    console.log("calling doesCircleAndRectCollide")
  ...
  doesCircleAndCircleCollide(
    ...
    console.log("calling doesCircleAndCircleCollide")
  ...
  doesRectAndRectCollide(
    ...
    console.log("calling doesRectAndRectCollide")
